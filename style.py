...
def image_loader2(image_name,size):
    w = size[2]
    h = size[3]
    image = Image.open(image_name).convert('RGB').resize((h,w))
...
def run_style_transfer(cnn, normalization_mean, normalization_std,
    ...
    """style_weight를 100000으로 줄이면 더욱 스무스하게 나온다."""
...
# 입력 이미지를 정규화하는 모듈을 생성하여 쉽게 nn.Sequential에 넣을 수 있습니다.
    ...
    content_img = image_loader("C:/Users/HP/Desktop/python/style_transfer/input2.png")
    style_img = image_loader2("C:/Users/HP/Desktop/python/style_transfer/style2.png",content_img.size())
